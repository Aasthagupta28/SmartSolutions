...
export default function DataAnalytics() {
  const features = [
    {
      ...
      description: 'We design SQL databases that run fast and can grow with your data. We optimize queries and indexes so everything stays quick.',
    ...
    },
    {
      ...
      description: 'Automated pipelines that grab data from one place, clean it up, and put it where you need it. Saves you time and reduces errors.',
    ...
    },
    {
      ...
      description: 'A central place to store all your business data. Makes it easy to analyze trends and make decisions based on real numbers.',
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'We build pipelines that move your data around, clean it up, and make sure everything flows smoothly.'
    },
    {
      step: '04',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8">
              We help you make sense of your data. From SQL databases to ETL pipelines, we turn your information into insights you can actually use.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From database design to dashboards, we build data solutions that help you understand your business and make better decisions.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We use modern data tools and technologies to build systems that are reliable, scalable, and actually work for your business.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Let's talk about your data and build solutions that help you understand your business better and make smarter decisions.
            </p>
