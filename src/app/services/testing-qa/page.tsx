...
export default function TestingQA() {
  const features = [
    ...
    },
    {
      ...
      description: 'Real people testing your app like real users would. We check edge cases and make sure everything works as expected.',
      benefits: ['User perspective testing', 'Edge case coverage', 'Usability testing', 'Exploratory testing']
    },
    {
      icon: Shield,
      title: 'Performance Testing',
      description: 'We test how your app handles traffic. Load testing shows us where it slows down, and we fix those bottlenecks.',
      benefits: ['Load testing', 'Stress testing', 'Performance monitoring', 'Optimization recommendations']
    },
    {
      icon: Shield,
      title: 'Security Testing',
      description: 'We test your app for security holes. Penetration testing, vulnerability scans, and fixes to keep your data safe.',
  ...
  const process = [
    {
      step: '01',
      title: 'Test Planning',
      description: 'We figure out what needs testing, how to test it, and create a plan that covers all the important stuff.'
    },
    {
      step: '02',
      title: 'Test Design',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8">
              We test your apps thoroughly so they work right, stay secure, and run fast. Quality assurance that actually catches problems.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From automated tests to security checks, we test everything thoroughly 
              so your apps work right and stay secure.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We use proven testing tools and frameworks to make sure we catch bugs 
              and deliver apps that work reliably.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Let's talk about your testing needs and set up quality assurance 
              that catches bugs and keeps your apps running smoothly.
            </p>
