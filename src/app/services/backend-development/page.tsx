...
export default function BackendDevelopment() {
  const features = [
    {
      ...
      description: 'Backend systems built with Django that can handle growth. Fast development and built-in security features.',
    ...
    },
    {
      ...
      description: 'Break your app into smaller services that work independently. Easier to scale and update without breaking everything.',
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'We test everything thoroughly and deploy to production. Then we monitor and fix any issues that come up.'
    }
  ]
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8">
              We build backend systems using Django, FastAPI, and other modern tools. Fast, secure, and built to handle growth.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We use modern backend technologies and frameworks to build 
              systems that scale, stay secure, and run fast.
            </p>
          </motion.div>
