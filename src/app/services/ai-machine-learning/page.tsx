  ...
  const features = [
    {
      ...
      description: 'Chatbots that actually understand what people are asking and give helpful answers. They sound natural, not robotic.',
      benefits: ['Natural language processing', '24/7 customer support', 'Multi-language support', 'Integration with existing systems']
    },
    {
      icon: Brain,
      title: 'Machine Learning Models',
      description: 'Machine learning models that learn from your data. They can predict trends, spot patterns, and help you make smarter decisions.',
      benefits: ['Predictive analytics', 'Pattern recognition', 'Automated decision making', 'Continuous learning']
    },
    {
      icon: Brain,
      title: 'Computer Vision Solutions',
      description: 'AI that can see and understand images and videos. Useful for quality control, security, and automation.',
      benefits: ['Object detection', 'Image classification', 'Facial recognition', 'Quality control automation']
    },
    {
      icon: Brain,
      title: 'Natural Language Processing',
      description: 'AI that reads and understands text. It can analyze sentiment, summarize documents, translate languages, and generate content.',
  ...
  const process = [
    {
      ...
      description: 'We look at your data, figure out what AI can help with, and make a plan that makes sense for your business.'
    },
    {
      step: '02',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8">
              We use AI and machine learning to automate your workflows, find patterns in your data, 
              and build tools that make your business run smoother.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From chatbots to data analysis, we build AI tools that automate your work and help you make better decisions.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We use modern AI and machine learning tools to build 
              solutions that actually help your business run better.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              A clear process for building AI that makes sure your solutions 
