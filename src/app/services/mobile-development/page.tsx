  ...
  const features = [
    {
      ...
      description: 'Build one app that works on both iPhone and Android. Write once, deploy everywhere.',
    ...
    },
    {
      ...
      description: 'Fast, smooth mobile apps built with Flutter. They look great and run fast on both platforms.',
      benefits: ['Material Design', 'Fast development', 'Excellent performance', 'Rich widget library']
    },
    {
      icon: Smartphone,
      title: 'iOS & Android Apps',
      description: 'Native apps built specifically for iOS or Android. Maximum performance and full access to device features.',
      benefits: ['Platform-specific optimization', 'Native UI components', 'Best performance', 'Full platform access']
    },
    {
      icon: Smartphone,
      title: 'Progressive Web Apps (PWA)',
      description: 'Websites that feel and work like mobile apps. Works offline and sends push notifications.',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8">
              We build mobile apps for iPhone and Android using React Native, Flutter, and native code. 
              They work great on both platforms and feel fast and smooth.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We handle everything from idea to app store. Our mobile apps keep users engaged and help your business grow.
            </p>
          </motion.div>
